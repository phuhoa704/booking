...
export const login = createAsyncThunk("auth/login", async (data, thunky) => {
  try {
...
export const logout = createAsyncThunk("auth/logout", async (data, thunky) => {
  try {
    thunky.dispatch(showLoading());
...
export const signup = createAsyncThunk("auth/signup", async (data, thunky) => {
  try {
    thunky.dispatch(showLoading());
