...
const Payment = () => {
  ...
  useEffect(() => {
    if (Object.keys(searchDetail).length > 0) {
      const departurePickupDetail = searchDetail.pickups.find(
        (sp) => sp.id === departurePickup
      );
      const departureDropDetail = searchDetail.drops.find(
        (sp) => sp.id === departureDrop
      );
      setDepartureTrip({
  ...
  useEffect(() => {
    if (Object.keys(returnDetail).length > 0) {
      const returnPickupDetail = returnDetail.pickups.find(
        (rp) => rp.id === returnPickup
      );
      const returnDropDetail = returnDetail.drops.find(
        (rp) => rp.id === returnDrop
      );
      setReturnTrip({
              ...
              <div className="flex gap-1.5 mb-2">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center text-sm gap-2">
                    ...
                    <span>{tPayment("qr_transfer_title")}</span>
                    <div className="p-1 bg-[#27ae5f] text-white flex items-center text-xs">
                      <BsShieldCheck className="text-white" />
                      <span>{tPayment("qr_transfer_description")}</span>
                    </div>
                  </div>
                  <div className="text-xs">
                    {tPayment("qr_transfer_details")}
                  </div>
                  {/* <div className="p-2 5">
              ...
              <div className="flex gap-1.5 my-2 relative">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center text-sm gap-2">
                    ...
                    <span>{tPayment("cash_payment_title")}</span>
                  </div>
                  <div className="text-xs">
                    {tPayment("cash_payment_description")}
                  </div>
                </div>
              </div>
              {/* <hr />
              ...
              <Collapse
                title={
                  <div className="flex justify-between font-semibold">
                    <div>{tPayment("total_amount")}</div>
                    <div>
                      {formatChangeNumber(
                        Object.keys(returnDetail).length > 0
                          ? `${
                              searchDetail.price * departureQuantity +
                              returnDetail.price * returnQuantity
                            }`
                          : `${searchDetail.price * departureQuantity}`
                      )}
                    </div>
                ...
                content={
                  <div className="flex flex-col">
                    <div className="flex justify-between border-b border-[#d9d9d9] py-2">
                      <div className="text-sm">{tPayment("ticket_price")}</div>
                      <p className="text-sm">
                        {formatChangeNumber(`${searchDetail.price}`)} x{" "}
                        {departureQuantity}
                      </p>
                    </div>
                    {Object.keys(returnDetail).length > 0 && (
                      <div className="flex justify-between border-b border-[#d9d9d9] py-2">
                        <div className="text-sm">
                          {tPayment("ticket_price")}
                        </div>
                        <p className="text-sm">
                          {formatChangeNumber(`${returnDetail.price}`)} x{" "}
                          {returnQuantity}
                        </p>
                      </div>
                    )}
              ...
              <div className="border border-[#D9D9D9] rounded-lg p-4 mb-2.5">
                <div className="flex justify-between items-center text-xs gap-2">
                  <div className="flex items-center gap-2">
                    <FaBus className="text-primary" />
                    <span>
                      {moment(new Date(searchDetail.start_time)).format(
                        "DD/MM/YYYY HH:mm"
                      )}
                    </span>
                ...
                <div className="border-t border-[#F2F2F2] mt-2">
                  <div className="p-2 flex gap-2.5">
                    <div className="w-1/4 rounded">
                      <img
                        src={`${API_STORE}${searchDetail?.vehicle_category?.image}`}
                        alt=""
                        className="rounded"
                      />
                    </div>
                    <div className="flex flex-col justify-center">
                      <p className="text-xs font-bold">
                        {searchDetail?.coach_company?.name}
                      </p>
                      <p style={{ fontSize: 9 }}>
                        {searchDetail?.vehicle_category?.name}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex text-xs items-center gap-2">
                      ...
                      <div className="flex flex-col">
                        {useDepartureCustomAddress ? (
                          ...
                          <>
                            <span className="font-semibold">
                              {searchDetail?.pickups?.find(
                                (p) => p.id === departurePickup
                              )
                                ? searchDetail.pickups.find(
                                    (p) => p.id === departurePickup
                                  ).name
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex flex-col">
                      <span className="font-bold">
                        {moment(new Date(searchDetail.end_time)).format(
                          "HH:mm"
                        )}
                      </span>
                      <span className="text-xs">
                    ...
                    <div className="flex text-xs items-center gap-2">
                      ...
                      <div className="flex flex-col">
                        {useDepartureDropAddress ? (
                          ...
                          <>
                            <span className="font-semibold">
                              {searchDetail?.drops?.find(
                                (p) => p.id === departureDrop
                              )
                                ? searchDetail.drops.find(
                                    (p) => p.id === departureDrop
                                  ).name
                ...
                <div className="border border-[#D9D9D9] rounded-lg p-4">
                  <div className="flex justify-between items-center text-xs gap-2">
                    <div className="flex items-center gap-2">
                      <FaBus className="text-primary" />
                      <span>
                        {moment(new Date(returnDetail.start_time)).format(
                          "DD/MM/YYYY HH:mm"
                        )}
                      </span>
                      <div className="flex items-center text-[#484848] gap-1.5">
                  ...
                  <div className="border-t border-[#F2F2F2] mt-2">
                    <div className="p-2 flex gap-2.5">
                      <div className="w-1/4 rounded">
                        <img
                          src={`${API_STORE}${returnDetail?.vehicle_category?.image}`}
                          alt=""
                          className="rounded"
                        />
                      </div>
                      <div className="flex flex-col justify-center">
                        <p className="text-xs font-bold">
                          {returnDetail?.coach_company?.name}
                        </p>
                        <p style={{ fontSize: 9 }}>
                          {returnDetail?.vehicle_category?.name}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex flex-col">
                        <span className="font-bold">
                          {moment(new Date(returnDetail.end_time)).format(
                            "HH:mm"
                          )}
                        </span>
                        <span className="text-xs">
        ...
        <div className="w-full xl:w-2/3 m-auto px-2.5 xl:px-0">
          <div className="flex justify-cennter gap-2.5 items-center">
            <div className="w-1/3 flex gap-2.5 flex-col xl:flex-row">
              <button
                className="bg-primary w-full text-sm text-white py-2.5 rounded-lg"
                onClick={async () => {
                  const order = {
                    name: state.name,
                    email: state.email,
                        ...
                        ? [
                            {
                              ...
                              trip_pickup: useDepartureCustomAddress
                                ? {
                                    ...
                                    province:
                                      departureCustomAddress.province.name,
                                    district:
                                      departureCustomAddress.district.name,
                                ...
                                : {
                                    ...
                                    province:
                                      departureTrip.trip_pickup.province.name,
                                    district:
                                      departureTrip.trip_pickup.district.name,
                              ...
                              trip_drop: useDepartureDropAddress
                                ? {
                                    ...
                                    time: searchDetail.start_time,
                                    province:
                                      departureDropAddress.province.name,
                                    district:
                                      departureDropAddress.district.name,
                                ...
                                : {
                                    ...
                                    province:
                                      departureTrip.trip_drop.province.name,
                                    district:
                                      departureTrip.trip_drop.district.name,
                            ...
                            },
                            {
                              ...
                              trip_pickup: useReturnCustomAddress
                                ...
                                : {
                                    ...
                                    province:
                                      returnTrip.trip_pickup.province.name,
                                    district:
                                      returnTrip.trip_pickup.district.name,
                              ...
                              trip_drop: useReturnDropAddress
                                ...
                                : {
                                    ...
                                    province:
                                      returnTrip.trip_drop.province.name,
                                    district:
                                      returnTrip.trip_drop.district.name,
              ...
              >
                {tPayment("booking_confirmation_title")}
              </button>
            ...
            <p className="text-sm w-2/3">
              {tPayment("booking_confirmation_message")}
            </p>
          </div>
          <p className="text-sm my-2">
            {tPayment("agreement_message")}{" "}
            <span className="text-primary underline font-semibold">
              {tPayment("payment_privacy_policy")}
            </span>{" "}
            <span className="text-primary underline font-semibold">
              {tPayment("terms_and_conditions")}
            </span>
          </p>
        </div>
      </div>
