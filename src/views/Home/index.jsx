            ...
            <section className='w-full bg-center bg-cover flex justify-center items-start xl:items-center relative h-smallContainer xl:h-largeContainer pt-16 xl:pt-0' style={{ backgroundImage: `url(${background})` }}>
                ...
                <div className="absolute bottom-0 py-2 xl:py-5 bg-blacktransparent w-full flex justify-center gap-4 xl:gap-12">
                    <div className="flex items-center flex-col gap-2 xl:flex-row">
                        ...
                        <span className='font-semibold text-center text-xs xl:text-base' style={{ color: text ? text : '#fff' }}>Chắc chắn có chỗ</span>
                    </div>
                    <div className="flex items-center gap-2 flex-col xl:flex-row">
                        ...
                        <span className='font-semibold text-center text-xs xl:text-base' style={{ color: text ? text : '#fff' }}>Hỗ trợ 24/7</span>
                    </div>
                    <div className="flex items-center gap-2 flex-col xl:flex-row">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className='font-semibold text-center text-xs xl:text-base' style={{ color: text ? text : '#fff' }}>Nhiều ưu đãi</span>
                    </div>
                    <div className="flex items-center gap-2 flex-col xl:flex-row">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className='font-semibold text-center text-xs xl:text-base' style={{ color: text ? text : '#fff' }}>Thanh toán đa dạng</span>
                    </div>
                </div>
            </section>
