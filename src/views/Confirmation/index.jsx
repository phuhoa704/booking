...
const Confirmation = () => {
  const { t: tConfirmation } = useTranslation("confirmation");
  ...
  const [bikes] = useState([
    {
      id: 1,
      name: "Honda Airblade, Honda Vision",
      type: "Xe tay ga",
      price: "150.000đ/ngày",
      method: "Giao xe tận nơi",
      img: tayga,
    },
    {
      id: 2,
      name: "Honda Wave RSX, Yamaha Sirius",
      type: "Xe số",
      price: "100.000đ/ngày",
      method: "Giao xe tận nơi",
      img: xeso,
  ...
  return (
    <>
      ...
      <Modal
        ...
        outlet={
          <CalendarComp
            tCalendarComp={tConfirmation}
            handleChange={setRangeDate}
            ranges={rangeDate}
            handleShow={setModalCalendar}
            handleConfirm={() => {
              navigate(ROUTER.SEARCH, {
                state: {
                  ...
                  start_date: moment(rangeDate[0].startDate).format(
                    "YYYY-MM-DD"
                  ),
      ...
      <div className="bg-[#F2F2F2] w-full pt-16 xl:p-0">
        <div className="w-full xl:w-2/3 m-auto py-5 px-2 xl:px-0">
          <div className="w-full">
            ...
            >
              <FaAngleLeft />
              <span className="text-primary">{tConfirmation("back")}</span>
            </div>
                ...
                <div className="rounded-xl border border-[#F2F2F2] p-5 bg-white my-5">
                  {!(Object.keys(user).length > 0) && (
                    <div className="w-full border border-[#0d2e59] p-2 flex items-center justify-between rounded">
                      <span className="text-[#0d2e59]">
                        {tConfirmation("login_and_earn_points")}
                      </span>
                      <button
                        className="px-2.5 py-2 text-white bg-[#0d2e59] rounded-lg"
                  ...
                  <form>
                    <input
                      ...
                      placeholder={tConfirmation("name")}
                    />
                    <div className="flex gap-2.5 my-2">
                      <button
                        type="button"
                        className="p-2.5 bg-white border border-[#D9D9D9] w-20 text-sm rounded"
                      >
                        VN +84
                      </button>
                      <input
                        type="text"
                        required
                        className="p-2.5 bg-white border border-[#D9D9D9] rounded"
                        style={{ width: "calc(100% - 80px)" }}
                        name="phone"
                        value={formVals.phone}
                        onChange={handleChange}
                        placeholder={tConfirmation("phone")}
                      />
                    </div>
                    <input
                      type="text"
                      ...
                      onChange={handleChange}
                      placeholder={tConfirmation("email")}
                    />
                  </form>
                  ...
                  <Collapse
                    title={
                      <div className="flex justify-between font-semibold">
                        <div>{tConfirmation("subtotal")}</div>
                        <div>
                          {formatChangeNumber(
        ...
        <div className="py-5 bg-white w-full">
          <div className="w-full xl:w-2/3 m-auto px-2.5 xl:px-0">
            <div className="flex justify-cennter gap-2.5">
              <button
                className="bg-primary text-white py-2.5 rounded-lg px-5"
                onClick={() => {
                  if (formVals.email && formVals.name && formVals.phone) {
                    ...
                    Toast.fire({
                      title: tConfirmation("please_enter_info"),
                      icon: "warning",
                    });
                  }
                }}
              >
                {tConfirmation("continue")}
              </button>
              <button
                className="bg-pending text-black py-2.5 rounded-lg px-5"
                onClick={() => setModalCalendar(true)}
              >
                {tConfirmation("return_trip_added")}
              </button>
              <p className="text-sm">{tConfirmation("booking_details")}</p>
            </div>
            <p className="text-sm my-2">
              {tConfirmation("agreement_text")}{" "}
              <span className="text-primary underline font-semibold">
                {tConfirmation("privacy_policy")}{" "}
              </span>{" "}
              <span className="text-primary underline font-semibold">
                {tConfirmation("terms_of_service")}
              </span>
            </p>
          </div>
        </div>
